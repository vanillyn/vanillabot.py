...
class Moderation(commands.Cog):
    ...
    async def ban(self, ctx, member: discord.Member = None, *, reason=None):
        ...
        await ctx.send(
            localization.get(
                "mod.ban.success", lang=lang, user=member.mention, reason=reason
            )
        )
    ...
    async def kick(self, ctx, member: discord.Member = None, *, reason=None):
        ...
        await ctx.send(
            localization.get(
                "mod.kick.success", lang=lang, user=member.mention, reason=reason
            )
        )
    ...
    async def unban(self, ctx, user_id: int):
        ...
        await ctx.send(
            localization.get("mod.unban.success", lang=lang, user=user.mention)
        )
